  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-portrait": "var(--gradient-portrait)",
      ...
      animation: {
        ...
        "fade-in": "fade-in 0.6s var(--transition-soft, cubic-bezier(0.22,1,0.36,1)) both",
        "fade-up": "fade-up 0.8s var(--transition-soft, cubic-bezier(0.22,1,0.36,1)) both",
